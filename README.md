...
```bash
yay -Syu neofetch gpg-tui jq jless difftastic zellij hyprpicker swaylock-effects waybar xdg-desktop-portal-hyprland unclutter brightnessctl btop dunst fd fzf github-cli network-manager-applet \
