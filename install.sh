...
installer ()
{
  ...
  yay -S nitch unclutter lxappearance arc-gtk-theme git papirus-icon-theme thunar alsa-utils alsa-firmware pipewire-audio pipewire-alsa pipewire-pulse bluez xclip feh nitrogen ranger alacritty lazygit atuin ttf-hack-nerd pacman-contrib trash-cli ttf-meslo-nerd httpie atuin zoxide exa bat starship nodejs rofi unzip --noconfirm --needed
  clear
