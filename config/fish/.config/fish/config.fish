...
if status --is-interactive
    ...
    bind \cf "fd -E '.git|node_modules' . | fzf --preview 'bat --color always {}' --header 'Open a file in nvim' --bind 'enter:become(nvim {})'" # [Ctrl + f] - Fizzy find a file/dir and open it in noevim
